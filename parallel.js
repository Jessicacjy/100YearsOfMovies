...
var colors = {
  "Adventure Action": [185,56,73],
  "Action": [37,50,75],
  "Animation": [325,50,39],
  "Adventure Fantasy": [10,28,67],
  "Mixed": [271,39,57],
  "Drama": [56,58,73],
  "Comedy": [28,100,52],
  "Thriller Drama": [41,75,61],
  "Comedy Family": [60,86,61],
  "Horror": [30,100,73],
  "Comedy Drama": [318,65,67],
  "Family": [274,30,76],
  "Documentary": [20,49,49],
  "News": [185,80,45],
  "Short": [10,30,42],
  "Film.Noir": [359,69,49]
};
...
d3.csv("sub_data_social.csv", function(raw_data) {
...
function data_table(sample) {
  ...
  var table = d3.select("#movie-list")
    .html("")
    .selectAll(".row")
      .data(sample)
    .enter().append("div")
...
function paths(selected, ctx, count) {
  ...
  data_table(shuffled_data.slice(0,15));
